...
export default function OwnerScreen() {
  ...
  const { marts, products, orders, advanceOrder, role, setRole } = useApp();
  const ownedMart = marts[marts.length - 1];
